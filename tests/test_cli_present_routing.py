...
def test_cmd_stats_missing_uses_present(tmp_path: Path, capsys: pytest.CaptureFixture[str]) -> None:
...
def test_cmd_simulate_present_header(capsys: pytest.CaptureFixture[str]) -> None:
...
def test_cmd_route_verbose_present_header(capsys: pytest.CaptureFixture[str]) -> None:
