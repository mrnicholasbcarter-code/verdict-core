...
`Launch decision` is a separate explicit state. It remains `PENDING EVIDENCE`
until every required row has evidence and a reviewer signs off. Empty rows are
not implicit passes.
