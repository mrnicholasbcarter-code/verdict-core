...
| --- | --- | --- | --- |
| Engineering reviewer | [Credential-free quickstart](../../README.md#quick-start) and [Verdict case study](VERDICT_PROOF_CASE_STUDY.md) | A deterministic local decision flow, explicit hard-gate exclusions, and the engineering boundary | It is a fixture, not live provider execution |
