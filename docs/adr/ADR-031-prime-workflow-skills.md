...
Related: ADR-021 deterministic provider receipts; ADR-023 governed swarm supervision (**SUPERSEDED the obsolete Ruflo/swarm/hivemind architecture removal (ADR-023, superseded by ADR-035)**); ADR-030 proof-carrying decision plane. This workflow consumes their authorities and does not replace routing or public wire contracts.
