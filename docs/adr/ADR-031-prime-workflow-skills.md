...
Related: ADR-021 deterministic provider receipts; ADR-023 governed swarm supervision (**SUPERSEDED** by ADR-035 after the Ruflo/swarm removal); ADR-030 proof-carrying decision plane. This workflow consumes their authorities and does not replace routing or public wire contracts.
